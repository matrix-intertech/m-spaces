...
const allowedOrigins = new Set([
    ...
    ...parseOriginList(process.env.VERCEL_URL ? `https://${process.env.VERCEL_URL}` : ''),
    ...parseOriginList(process.env.VERCEL_PROJECT_PRODUCTION_URL ? `https://${process.env.VERCEL_PROJECT_PRODUCTION_URL}` : ''),
